...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/MatrixDriver/MatrixDriver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockDividerMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockDividerMain.tcl
