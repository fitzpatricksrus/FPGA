...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/LEDMatrix8x8/LEDMatrix8x8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDMatrix8x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LEDMatrix8x8.tcl
