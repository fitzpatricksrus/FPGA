...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/LEDControl/LEDControl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Matrix_Stepper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_Matrix_Stepper.tcl
