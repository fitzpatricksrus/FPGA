...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/LEDControl/LEDControl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Matrix_Stepper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LED_Matrix_Stepper.tcl -notrace
