...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/SCRATCH/SCRATCH.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InverterMain.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InverterMain.tcl -notrace
