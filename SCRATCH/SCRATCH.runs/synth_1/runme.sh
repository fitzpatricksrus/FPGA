...
HD_PWD='C:/Users/stuff/Documents/Projects/FPGA/SCRATCH/SCRATCH.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InverterMain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InverterMain.tcl
